(ns validator.validate
  (:require [cljs.reader :refer [read-string]]
            [instaparse.core :as insta]))

;; Mostly swiped from https://github.com/diogo149/lein-edn-validator/blob/master/src/leiningen/edn_validator.clj
...
(defn form-parser
  ...
  (let [output (form-parser* s)]
    (if (insta/failure? output)
      (throw (js/Error (with-out-str (print output))))
      output)))
